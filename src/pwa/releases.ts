...
export const releases: ReleaseNote[] = [
  {
    ...
    date: '2026-09-04',
    title: '回退复盘编辑器键盘适配',
    summary: '恢复按可视视口定位复盘编辑器，避免 Android 软键盘唤起时编辑界面折叠。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.16/app-release.apk',
    changes: [
      '复盘编辑器重新跟随 visualViewport 的顶部和高度定位',
      '软键盘占用空间时，取消、确认、文本编辑区仍保持在可视范围内',
      '浏览器移动视口回归已通过，Android 真机仍需安装 APK 验收',
    ],
  },
  {
    version: '0.9.15',
    date: '2026-09-04',
    title: '复盘编辑器键盘适配尝试（未在 Android 真机生效）',
    summary: '曾调整软键盘布局，但实际 Android 设备仍出现编辑界面折叠；已在 0.9.16 回退并重新验证。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.15/app-release.apk',
    changes: [
      '移动端键盘布局调整未在 Android 真机生效',
      '后续修复请以 Android APK 真机验收结果为准',
    ],
  },
  {
    version: '0.9.14',
    date: '2026-09-02',
    title: '优化复盘导出布局',
    summary: '复盘导出入口在手机端并排显示，便于快速选择周期复盘或按日期导出。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.14/app-release.apk',
    changes: [
      '导出周复盘与按日期导出在手机端并排显示',
    ],
  },
  {
    version: '0.9.11',
    date: '2026-09-02',
    title: '修复 Android 通知构建',
    summary: '修复 Android 原生通知权限回调，确保云端 Release 可以正常编译。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.11/app-release.apk',
    changes: ['修复 Capacitor 8 通知权限回调实现', '复盘导出目录优化和移动端编辑修复（实际设备未生效）'],
  },
  {
    version: '0.9.10',
    date: '2026-09-02',
    title: '优化复盘导出路径',
    summary: '支持按日期范围导出复盘，并可合并为单个文件或一次写入多个文件。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.10/app-release.apk',
    changes: [
      '多文件导出改为一次选择目录，避免逐个选择保存路径',
      'Android 端多文件复盘继续保存到 Documents/kedu-focus',
      '修复移动端复盘编辑器聚焦后键盘遮挡问题（实际设备未生效）',
    ],
  },
  {
    version: '0.9.9',
    date: '2026-08-24',
    title: '修复 Android 复盘键盘遮挡（实际设备未生效）',
    summary: '调整移动端复盘编辑器，使软键盘弹出后编辑区域跟随可视高度并保持独立滚动。（实际设备未生效）',
  ...
  },
  {
    ...
    date: '2026-08-24',
    title: '优化桌面入口与复盘体验',
    summary: '补齐 PC 网页的更多入口，调整设置页管理项顺序，并完善复盘预览与历史复盘操作。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.7/app-release.apk',
    changes: [
      'PC 桌面导航新增更多入口，可直接访问数据健康和数据管理',
      '设置页将分类管理和计时偏好上移，应用与本机保护置于底部',
      '历史复盘支持分页、日期选择、周期模板导出和全屏只读预览',
    ],
  },
  {
    version: '0.9.6',
  ...
  },
  {
    ...
    summary: '汇总 0.9.4 之后已合入 0.9.5 的 Android 更新、备份、同步、复盘、睡眠和重复任务归档改动。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.5/app-release.apk',
    changes: [
      'Android 更新改为应用内下载并显示进度，完成后进入系统安装确认',
      '修复更新提示关闭状态和 WebDAV 同步请求超时问题',
      'Android 备份保存位置、复盘历史和睡眠历史分页体验优化',
      '复盘编辑适配移动端输入法，重复任务归档按来源折叠但保留每条记录',
    ],
  },
  {
    version: '0.9.4',
  ...
  },
  {
    ...
    date: '2026-08-21',
    title: '专注记录与同步处理更顺手',
    summary: '集中修复专注纠错、任务详情、番茄轮次、移动端同步差异和数据健康导航问题。',
    changes: [
      '今日专注记录支持编辑开始时间、结束时间、任务、分类和备注，并自动重算实际时长',
      '今日任务和逾期任务可以直接打开详情并进入编辑，完成复选框保持独立',
      '计时任务下拉仅显示今天及逾期的未完成任务，过滤未来重复任务和失效选择',
      '番茄轮次改为按北京时间当天记录计算，显示今日次数与本组第 N/4 轮',
      '手机端 WebDAV 差异默认折叠，同时保留本机覆盖云端、云端覆盖本机和安全合并入口',
      '新增独立数据健康页面，手机端从更多进入，设置页保留摘要入口',
      '新增专注记录更新状态操作，沿用原记录 ID 并刷新 updatedAt，兼容现有同步格式',
    ],
  },
  {
    version: '0.8.1',
    date: '2026-08-16',
    title: '手机统计控件回到界面内',
    summary: '修复窄屏手机上统计周期、范围与日均控件被挤出卡片的问题。',
    changes: [
      '周、月、年与自定义周期在手机端改为完整的等宽一行',
      '统计范围和日均口径改为上下布局，不再互相争抢横向空间',
      '自定义日期、图表和睡眠统计卡片允许安全收缩到屏幕宽度',
      '24 小时专注刻度继续保留卡片内部滚动，不再带动整个页面横移',
    ],
  },
  {
    version: '0.8.0',
    date: '2026-08-16',
    title: '重复任务历史变轻了',
    summary: '已完成列表不再无限堆积，较早的重复任务会安全转换为轻量完成归档。',
    changes: [
      '已完成与全部列表默认只展示最近 30 天的完成记录',
      '较早记录统一收进可展开的历史归档，不再占据第一屏',
      '超过 90 天的重复任务完整实例自动转换为轻量完成记录',
      '轻量记录继续保留日历、复盘、周期回顾、CSV 和同步所需信息',
      '完成记录沿用原任务 ID，旧设备和旧备份不会把已压缩任务重新带回来',
      'IndexedDB、JSON 备份和 WebDAV 均兼容旧版本数据',
    ],
  },
  {
    version: '0.7.0',
    date: '2026-08-16',
    title: '数据状态现在一目了然',
    summary: '加入数据健康面板，并重新设计专注与睡眠统计的时间表达。',
    changes: [
      '设置页新增数据健康面板，展示记录、墓碑、体积、浏览器空间、备份与同步时间',
      '墓碑采用 90 天观察区和同步水位策略，在确认安全前不会自动物理删除',
      '专注趋势显示小时刻度，专注时段改为连续的 24 小时柱形刻度',
      '睡眠趋势增加 7—9 小时参考区，并展示作息波动与达标比例',
      '新增从中午到次日中午的典型睡眠窗，以及最近七晚对比',
      '睡眠记录页增加近期历史，可以直接选择过去的记录查看或修改',
    ],
  },
  {
    version: '0.6.1',
    date: '2026-08-16',
    title: '同步差异更准确了',
    summary: '精简 WebDAV 操作入口，并修复未改动任务被批量判为冲突的问题。',
    changes: [
      'WebDAV 只保留一个“检查并同步”入口，检查本身不会直接上传或下载',
      '空的可选字段不再因为 JSON 省略规则而被误判为内容修改',
      '分类的默认启用状态按相同含义比较，不再产生无效差异',
      '同一天且内容相同的复盘或睡眠记录，不再因设备生成的 ID 不同而冲突',
      '语义一致时直接提示无需同步，不再展示全为零的差异账本',
    ],
  },
  {
    version: '0.6.0',
    date: '2026-08-14',
    title: '云端旧版本可以找回了',
    summary: '设置页现在能查看、比较并安全恢复局域网服务器保留的历史备份。',
    changes: [
      '云端历史版本按时间刻度展示，并标出任务、专注、复盘和睡眠数量',
      '选择任一历史快照后，可逐条比较它与本机的数据差异',
      '支持下载历史 JSON、安全合并到本机或整份恢复本机',
      '恢复前必须先保存当前本机备份，历史恢复不会修改云端活动文件',
      '同步服务的历史清单和快照下载均为只读，并继续受账号密码保护',
    ],
  },
  {
    version: '0.5.0',
