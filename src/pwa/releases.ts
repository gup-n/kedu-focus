...
export const releases: ReleaseNote[] = [
  {
    version: '0.9.16',
    date: '2026-09-04',
    title: '复盘与 Android 体验整合更新',
    summary: '整合复盘编辑、历史分页、导出和 Android 发布流程的近期改进，并回退导致键盘唤起时界面折叠的适配。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.16/app-release.apk',
    changes: [
      '复盘编辑器重新跟随 visualViewport 的顶部和高度定位，软键盘占用空间时保持完整可见',
      '历史复盘分页显示上一页、页码和下一页，周复盘与按日期导出入口并排',
      'Android 发布改为 GitHub Actions 构建；持续通知仍未通过真机验证，不作为已解决功能',
