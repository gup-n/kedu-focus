...
export const releases: ReleaseNote[] = [
  ...
  },
  {
    ...
    summary: '固定手机复盘编辑器的全屏结构，键盘出现时不改变外层布局，并汇总近期复盘分页与导出体验。浏览器回归已完成，Android 真机待验收。',
    apkUrl: 'https://github.com/gup-n/kedu-focus/releases/download/v0.9.17/app-release.apk',
    changes: [
      '手机端复盘编辑器固定铺满全屏，取消外层留白和 visualViewport 顶部/高度驱动',
      '编辑时使用独立正文滚动区和尾部余量，空内容也可向下滚动；键盘出现时外层标题与操作区保持不变',
      '历史复盘分页显示上一页、页码和下一页，周复盘与按日期导出入口并排',
      'Android APK 交由 GitHub Actions 构建；浏览器 390×844 回归通过，Android 真机键盘行为待验收',
    ],
  },
  {
    version: '0.9.8',
