...
export interface Task { id: string; title: string; note: string; plannedDate: string; dueDate: string; priority: Priority; categoryId: string; estimatedPomodoros: number; completedAt?: string; updatedAt?: string; deletedAt?: string }
